...
# ---------------- paths ----------------
BACKTEST_CSV = Path("data/backtest_tier2/backtest_results_ga_vs_gabo.csv")
OUT_DIR = Path("results/chap5/backtest_arima"); OUT_DIR.mkdir(parents=True, exist_ok=True)
FIG_A = OUT_DIR/"Fig_5_4a_arima_sharpe_by_interval.png"
FIG_B = OUT_DIR/"Fig_5_4b_arima_sharpe_overall.png"
...
ax.set_title("Sharpe distribution by retraining interval — ARIMA (backtest)", fontsize=12, pad=8)

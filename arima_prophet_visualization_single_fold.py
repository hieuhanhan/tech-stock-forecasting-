...
fig.suptitle(f'Backtest Performance for {TICKER_TO_PLOT} (2020)', fontsize=20, weight='bold')
...
ax1.plot(results_df['Date'], results_df['arima_equity'], label='Winning ARIMA (1,1,1) Strategy', lw=2.5, color='green')

...
def main():
    ...
    parser.add_argument('--tier2-json', default='data/tuning_results/jsons/debug_zscore.json')
    parser.add_argument('--tier2-csv', default='data/tuning_results/csv/debug_zscore.csv')
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler("logs/debug_zscore.log"),
    ...
    for fid, params in tqdm(champion_items, desc="Sensitivity Analysis"):
        ...
        for interval in retrain_intervals:
            ...
            z_thr_vals = [0.5, 1.0, 1.5, 2.0]
            seeds = [[params['p'], params['q'], t + np.random.uniform(-0.05, 0.05)] for t in z_thr_vals]

...
plt.grid(True)
plt.tight_layout()
plt.savefig("figures/portfolio_equity_curve_all.png")
plt.show()
...
# ========== Load Summary ==========
df_summary = pd.read_csv("data/backtest_results/all_tickers_arima_backtest_summary.csv")
...
plt.tight_layout()
plt.savefig("figures/sharpe_per_ticker_all.png")
plt.show()
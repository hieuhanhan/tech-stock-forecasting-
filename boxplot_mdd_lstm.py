...
# ---------------- paths ----------------
BACKTEST_CSV = Path("tuning_results/backtest_lstm/backtest_lstm_results.csv")
OUT_DIR = Path("tuning_results/chap5/backtest_lstm"); OUT_DIR.mkdir(parents=True, exist_ok=True)
FIG_A = OUT_DIR/"Fig_5_4a_lstm_mdd_by_interval.png"
FIG_B = OUT_DIR/"Fig_5_4b_lstm_mdd_overall.png"
...
ax.set_title("MDD distribution by retraining interval — LSTM (backtest)", fontsize=12, pad=8)
